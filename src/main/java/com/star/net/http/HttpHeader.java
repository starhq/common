...
public enum HttpHeader {
	...
	/**
	 * 如果报文采用了分块传输编码(chunked transfer encoding)
	 * 方式,就可以用这个首部列出位于报文拖挂(trailer)部分的首部集合
	 */
	TRAILER("Trailer"),
	...
	/**
	 * 用来包含实现特定的指令，最常用的是Pragma:no-cache。在HTTP/1.1协议中，它的含义和Cache-
	 * Control:no-cache相同
	 */
	PRAGMA("Pragma"),
	...
	/**
	 * 指定请求资源的Intenet主机和端口号，必须表示请求url的原始服务器或网关的位置。HTTP/1.1请求必须包含主机头域，
	 * 否则系统会以400状态码返回
	 */
	HOST("Host"),
	/**
